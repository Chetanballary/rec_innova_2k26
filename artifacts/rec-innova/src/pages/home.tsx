...
import { ArrowRight, Calendar, Music, Flame, Sparkles, Trophy, Star, Zap, Video, Fingerprint, MessageSquare } from "lucide-react";
...
const EVENTS = [
  ...
  { icon: MessageSquare, label: "Debate", color: "#06b6d4" },
];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-accent/30 bg-accent/10 text-accent mb-4">
              <Trophy size={14} />
              <span className="font-rajdhani text-xs font-semibold tracking-widest uppercase">9 Competitions</span>
            </div>
            <h2 className="font-orbitron text-3xl md:text-5xl font-black text-white mb-4">Events Lineup</h2>
            <p className="font-rajdhani text-lg text-muted-foreground max-w-xl mx-auto">Compete across nine electrifying categories and bring home the glory</p>
          </motion.div>
